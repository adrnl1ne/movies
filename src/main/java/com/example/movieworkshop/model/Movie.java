...
import com.example.movieworkshop.controller.MovieController;
...
public class Movie implements Comparable<Movie> {
    ...
    public Movie(String year, String length, String title, String subject, String popularity, String awards, int id) {
        this.year = year;
        this.length = length;
        this.title = title;
